...
let a = {first_name: "Ricky", last_name: "Martinez", email:"ricky@email.com"};
...
let b = [{first:"bob", last:"smith"},{first:"mary", last:"smith"}, {first:"tom", last:"jones"}]; 

console.log(b[0]); 

// # 3. Make a hash to store prices for 3 different menu items. Then add a new menu item and price and print the hash to see the result.

let c = {burger:4, hotdog:3, fries:2}; 
c.salad = 2.5; 
console.log(c); 

// # 4. Make a hash to store a book's title, author, number of pages, and language. Then print each attribute on separate lines.

let d = {title:"the hobbit", author:"jrr tolkien", pages:600}; 
console.log(d.title); 
...
let e = [{title:"the hobbit", author: "jrr tolkien"}, {title:"a game of thrones", author:"george rr martin"}, {title:"american gods", author:"neil gaiman"}]; 

console.log(e[2].author); 

// # 6. Make a hash to store 3 different states and their captitals. Then add a new state and capital and print the hash to see the result.

let f = {illinois:"springfield", indiana:"indianaplis", colorado:"denver"}; 
f.new_york = "albany"; 
console.log(f); 

// # 7. Make a hash to store a laptop's brand, model, and year. Then print each attribute on separate lines.

let g = {brand:"apple", model:"macbook", year:2020}; 
console.log(g.brand);
console.log(g.model);
console.log(g.year); 
...
let h = [{brand:"apple", model:"macbook"}, {brand:"dell", model:"XPS"}, {brand:"acer", model:"chromebook"}]; 

console.log(h[1].model); 

// # 9. Make a hash to store definitions for 2 different words. Then add a new word and definition and print the hash to see the result.

let i = {apple:"fruit", carrot:"vegetable"}; 
i.water = "liquid"; 

console.log(i);

// # 10. Make a hash to store a shirt's brand, color, and size. Then print each attribute on separate lines.
let j = {brand:"hanes", color:"black", size:"large"}; 
